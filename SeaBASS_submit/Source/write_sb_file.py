...
def hdr_hplc(amt, fn_docs):
    ...
    "/data_file_name=": "",
    "/documents=": fn_docs,     
    "/calibration_files=": "HPLC_method_summary.pdf", 
    "/data_type=": "pigment",
    "/data_status=": "preliminary",
    "/start_date=": "yyyymmdd",
    "/end_date=": "yyyymmdd",
    ...
    _fields ='sample,depth,lat,lon,year,month,day,time,volfilt,allo,alpha-beta-car,but-fuco,chl_c1c2,chl_c3,chlide_a,diadino,diato,dp,dv_chl_a,dv_chl_b,fuco,gyro,hex-fuco,lut,mv_chl_a,mv_chl_b,neo,perid,phide_a,phytin_a,ppc,pras,psc,psp,tacc,tcar,tchl,tot_chl_a,tot_chl_b,tot_chl_c,tpg,viola,zea' # caution: copied from hdr function
    _units = 'none,m,degrees,degrees,yyyy,mo,dd,HH:MM:SS,l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l'
    ## note - mv_chlb, dv_chlb, gyro are added (not present in some of the other labs)
...
def data_table_hplc(amt):
    ...
    #sample = amt['hplc_Original_PI_Sample_Label'].to_pandas()
    ...
    time = times
 #   bottle = amt['hplc_Bottle_Number'].to_pandas() # check 
    volfilt = 1000*amt['hplc_Volume_filtered_(ml)'].to_pandas() # check
      
    # pigments - note pigment sums are inlcuded, by ratios are not (user can easily derive)
    ...
    print('     concatenating Series...')    
    amt2csv = pd.concat([sample,depth,lat,lon,year,month,day,time,volfilt,allo,alpha_beta_car,but_fuco,chl_c1c2,chl_c3,chlide_a,diadino,diato,dp,dv_chl_a,dv_chl_b,fuco,gyro,hex_fuco,lut,mv_chl_a,mv_chl_b,neo,perid,phide_a,phytin_a,ppc,pras,psc,psp,tacc,tcar,tchl,tot_chl_a,tot_chl_b,tot_chl_c,tpg,viola,zea],  axis=1)
...
if __name__ == '__main__':
        ...
        # nc file
        finalnc = '/users/rsg/tjor/scratch_network/AMT_underway/AMT22/Processed/Step3/amt22_final_with_debiased_chl.nc' # hardcoded
        amt_no = finalnc.split("/")[-1].split("_")[0]

        # calibration file
        fn_cal = 'acs094.dev'  # hardcoded
    
        # document files
        fn_docs = 'checklist_acs_particulate_inline_AMT22.rtf,checklist_acs_ag_cg_AMT22.rtf,AMT22_ACS_inline_ProcessingReport.docx' # hardcoded
        fn_docs_hplc = 'checklist_hplc_NASA_AMT22.rtf,Behrenfeld_02-14_report.xlsx'
